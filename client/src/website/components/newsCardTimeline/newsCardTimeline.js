...
import styles from './newsCardTimeline.module.css';
 ...
 * news.
 */
class NewsCardTimeline extends Component {
...
export default CSSModules(NewsCardTimeline, styles, { allowMultiple: true, handleNotFoundStyleName: "log" })
