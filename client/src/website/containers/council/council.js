...
class Council extends Component {
    ...
    render() {
        return <div styleName="membersBody">
                    <div styleName="membersBanner" style={{backgroundImage: `url('https://res.cloudinary.com/dohwohspb/image/upload/v1548351696/images/website/pexels-photo-917494.jpg')`}}>
                    </div>
                    <div className="push-top">
                        <div styleName="membersTop">
                            ...
                            <PageContent
                                content={
                                "Le conseil municipal représente la population et prend les décisions sur les orientations et les priorités d’action de la municipalité. Il doit s’assurer que les services offerts dans la municipalité répondent aux besoins de la communauté. " +
