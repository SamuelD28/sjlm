...
const inputTypes = ['select', 'text', 'uploader', 'texteditor', 'toggle', 'password', 'tel', 'email', 'date', 'number'];
 ...
 * id: specify that the value is going to hold an object id
 */
class InputSchema {
    constructor({
        name = "Unnamed Input",
        ...
        Utility.VerifyProperty(this.id, Boolean);
